...
namespace RamuneLib.Utils
{
    public static class PrefabUtils
    {
        ...
        public static RecipeData CreateRecipe(int craftAmount, params CraftData.Ingredient[] ingredients)
        {
            return new RecipeData()
            {
                craftAmount = craftAmount,
                Ingredients = new List<CraftData.Ingredient>(ingredients)
            };
        }
        ...
        {
            var ingredients = recipeItems.OfType<CraftData.Ingredient>().ToArray();

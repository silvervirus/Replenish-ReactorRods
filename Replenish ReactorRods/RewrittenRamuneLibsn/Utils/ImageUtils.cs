...
namespace RamuneLib.Utils
{
    public static class ImageUtils
    {
        ...
        /// <summary>
        /// Loads and returns a <see cref="Atlas.Sprite"/> loaded from the Assets folder using the filename provided.
        /// </summary>
        /// <param name="filename">The filename of the sprite to load.</param>
        /// <returns>The loaded <see cref="Atlas.Sprite"/>.
        ...
        /// <summary>
        /// Returns the passed <see cref="Atlas.Sprite"/> as a <see cref="Atlas.Sprite"/> 
        /// </summary>
